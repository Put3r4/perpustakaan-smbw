            ...
            <div class="flex h-full flex-col">
                <div class="border-b border-slate-200 px-5 py-5">
                    <a href="{{ route('dashboard') }}" class="flex items-center gap-3">
                        <span
                            class="flex size-10 items-center justify-center rounded-md bg-emerald-700 text-sm font-semibold text-white">PK</span>
                        <span>
                ...
                <nav class="flex-1 space-y-5 overflow-y-auto px-3 py-4 text-sm">
                    ...
                    <div>
                        ...
                        <div class="mt-2 space-y-1">
                            ...
                            <x-dashboard.nav-link :href="route('kategori.index')" :active="request()->routeIs('buku.kategori.*')">Kategori
                                Buku</x-dashboard.nav-link>
                    ...
                    <div>
                        ...
                        <div class="mt-2 space-y-1">
                            <x-dashboard.nav-link :href="route('transaksi.peminjaman.index')"
                                :active="request()->routeIs('transaksi.peminjaman.*')">Peminjaman</x-dashboard.nav-link>
                    ...
                    <div>
                        ...
                        <div class="mt-2 space-y-1">
                            <x-dashboard.nav-link :href="route('kunjungan.check-in.index')" :active="request()->routeIs('kunjungan.*')">Check-In
                                Pengunjung</x-dashboard.nav-link>
                        </div>
                    </div>
                    ...
                    <div>
                        ...
                        <div class="mt-2 space-y-1">
                            <x-dashboard.nav-link :href="route('laporan.peminjaman.index')"
                                :active="request()->routeIs('laporan.peminjaman.*')">Peminjaman</x-dashboard.nav-link>
                            <x-dashboard.nav-link :href="route('laporan.pengembalian.index')"
                                :active="request()->routeIs('laporan.pengembalian.*')">Pengembalian</x-dashboard.nav-link>
                            ...
                            <x-dashboard.nav-link :href="route('laporan.keanggotaan.index')"
                                :active="request()->routeIs('laporan.keanggotaan.*')">Keanggotaan</x-dashboard.nav-link>
                        </div>
                    </div>
        ...
        <div class="min-w-0 flex-1">
            <header class="border-b border-slate-200 bg-white">
                <div class="flex items-center justify-between gap-4 px-4 py-4 sm:px-6 lg:px-8">
                    ...
                    <a href="{{ route('home') }}"
                        class="rounded-md border border-slate-200 px-3 py-2 text-sm font-medium text-slate-700 hover:bg-slate-50">Lihat
                        Home</a>
                </div>
            </header>
