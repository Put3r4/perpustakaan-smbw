<x-layouts.dashboard title="Edit Anggota Non Pelajar">
...
<div class="max-w-6xl mx-auto">
    ...
    <div class="bg-white rounded-xl border border-slate-200 shadow-sm">
        ...
        <form method="POST"
              action="{{ route('anggota.non-pelajar.update', $anggota) }}"
              class="p-6">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <div>
                    ...
                    <input type="text" name="ttl"
                           value="{{ old('ttl', $anggota->ttl) }}" placeholder="Contoh: Sumbawa, 17 Agustus 1995"
