<x-layouts.dashboard title="Tambah Anggota Pelajar">
    ...
    <div class="bg-white rounded-xl border border-slate-200 shadow-sm">
        ...
        <div class="border-b border-slate-200 px-6 py-4">
            <h2 class="text-lg font-semibold text-slate-800">
                Form Tambah Anggota Pelajar
            </h2>
            <p class="text-sm text-slate-500 mt-1">
                Lengkapi data anggota dan akun login perpustakaan.
            </p>
        </div>

        <form method="POST"
              action="{{ route('anggota.pelajar.store') }}"
              class="p-6">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <div>
                    ...
                    <input type="text" name="nim_nis" value="{{ old('nim_nis') }}"
                ...
                <div class="md:col-span-2">
                    ...
                    <textarea name="alamat_ortu" rows="3"
                              class="w-full rounded-lg border border-slate-300 px-3 py-2 @error('alamat_ortu') border-red-500 @enderror">{{ old('alamat_ortu') }}</textarea>
